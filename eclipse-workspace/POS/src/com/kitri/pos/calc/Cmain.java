...
//		frame.dispose();
	...
	public Cmain() {
		setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		setTitle("Force.pos");
		setAlwaysOnTop(true);
		...
		titleLabel.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 25));
		titleLabel.setBounds(14, 8, 241, 31);
		pStatusBar.add(titleLabel);
		
		notice = new JTextField();
		notice.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.PLAIN, 20));
		...
		dateLabel.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.PLAIN, 20));
		...
		idLabel.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		mBtnInven.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		mBtnSale.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		mBtnCalc.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		mBtnStat.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		mBtnAccount.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		sBtnCustomer.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		sBtnDisuse.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		sBtnPdInput.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		sBtnPdChange.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
		...
		sBtnPdCancel.setFont(new Font("占쏙옙占쏙옙 占쏙옙占�", Font.BOLD, 20));
