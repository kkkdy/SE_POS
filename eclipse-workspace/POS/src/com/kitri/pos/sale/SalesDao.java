...
import com.kitri.pos.sales.DBManager;
...
//	환불 고객이 구매한 재고 변경
	public void updateStock(Vector<com.kitri.pos.PosDto> list) {
		int result = 0;
		...
		try {
			...
			for(int i = 0; i < size; i++) {
				ps.setInt(1, list.get(i).getSellCount());
				ps.setString(2, list.get(i).getProductCode());
				
				System.out.println("날짜 : " + list.get(i).getInDate());
				ps.setString(3, list.get(i).getInDate());
